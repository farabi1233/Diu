...
$con = connect_db();
$sql = "SELECT donor_list.*, donate.date , donate.venue FROM donor_list JOIN donate on donor_list.id = donate.user_id WHERE donor_list.id= donate.user_id AND donor_list.blood_group = 'AB-' ORDER BY donate.user_id DESC";
