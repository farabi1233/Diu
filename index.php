        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <div class="banner-content">
                    ...
                    <a href="http://localhost/DIU/registration_donor.php" class="btn btn-slider"><b>DONATE NOW!</b> </a>
                    <?php echo "&nbsp;" ?>

                    <a href="http://localhost/DIU/request_blood.php" class="btn btn-slider"><b> REQUEST FOR BLOOD</b></a>
                </div>
            </div>
        </div>
    ...
    <div class="container wow fadeInUp">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                $con1 = connect_db();
                $sql = "SELECT donor_list.*, COUNT(*) as count FROM donor_list JOIN donate on donor_list.id = donate.user_id WHERE donor_list.id= donate.user_id GROUP BY donor_list.id LIMIT 3";
