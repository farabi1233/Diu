            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="update.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="name">Description(required):</label>
                            <textarea required type="text" class="form-control" name="description" placeholder="Campaign Details" rows="3"> <?php echo $row['description'];  ?></textarea>
                        </div>
                        <div class="form-group">
